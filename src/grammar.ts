...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "relativeDate", "symbols": ["duration", "_", "fromConnector", "_", "now", "_", "atConnector", "_", "time"], "postprocess": d => makeRelativeDate('future', d[0], undefined, d[8])},
    {"name": "relativeDate", "symbols": ["duration", "_", "fromConnector", "_", "now", "_", "atConnector", "_", "timeWord"], "postprocess": d => makeRelativeDate('future', d[0], undefined, { special: d[8] })},
    ...
    {"name": "relativeDate", "symbols": ["weekday", "_", "inConnector", "_", "duration"], "postprocess": d => makeRelativeDate('future', d[4], makeDate({ weekday: d[0] }))},
    {"name": "relativeDate", "symbols": ["weekday", "_", "inConnector", "_", "wordNumber", "_", "unit"], "postprocess": d => makeRelativeDate('future', makeDuration(parseWordNumber(d[4]), d[6]), makeDate({ weekday: d[0] }))},
    {"name": "relativeDate", "symbols": ["weekday", "_", "duration", "_", "agoConnector"], "postprocess": d => makeRelativeDate('past', d[2], makeDate({ weekday: d[0], relative: 'last' }))},
    {"name": "relativeDate", "symbols": ["weekday", "_", "wordNumber", "_", "unit", "_", "agoConnector"], "postprocess": d => makeRelativeDate('past', makeDuration(parseWordNumber(d[2]), d[4]), makeDate({ weekday: d[0], relative: 'last' }))},
    {"name": "relativeDate", "symbols": ["timeWord", "_", "inConnector", "_", "duration"], "postprocess": d => makeRelativeDate('future', d[4], undefined, { special: d[0] })},
    {"name": "relativeDate", "symbols": ["timeWord", "_", "inConnector", "_", "wordNumber", "_", "unit"], "postprocess": d => makeRelativeDate('future', makeDuration(parseWordNumber(d[4]), d[6]), undefined, { special: d[0] })},
    {"name": "relativeDate", "symbols": ["timeWord", "_", "duration", "_", "agoConnector"], "postprocess": d => makeRelativeDate('past', d[2], undefined, { special: d[0] })},
    {"name": "relativeDate", "symbols": ["timeWord", "_", "wordNumber", "_", "unit", "_", "agoConnector"], "postprocess": d => makeRelativeDate('past', makeDuration(parseWordNumber(d[2]), d[4]), undefined, { special: d[0] })},
    ...
    {"name": "duration", "symbols": ["number", (lexer.has("dash") ? {type: "dash"} : dash), "unit"], "postprocess": d => makeDuration(d[0], d[2])},
    {"name": "duration", "symbols": ["wordNumber", "_", "unit"], "postprocess": d => makeDuration(parseWordNumber(d[0]), d[2])},
    {"name": "duration", "symbols": ["wordNumber", "_", "wordNumber", "_", "unit"], "postprocess": d => makeDuration(parseTwoWordNumber(d[0], d[2]), d[4])},
    {"name": "duration", "symbols": ["wordNumber", "_", "ofConnector", "_", "unit"], "postprocess": d => makeDuration(parseWordNumber(d[0]), d[4])},
    {"name": "duration", "symbols": ["wordNumber", "_", "wordNumber", "_", "ofConnector", "_", "unit"], "postprocess": d => makeDuration(parseTwoWordNumber(d[0], d[2]), d[6])},
